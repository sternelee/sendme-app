...
import { Cloud, Download, Radio } from "lucide-solid";
    ...
    <Show when={topReminder()}>
      ...
      >
        ...
        >
          ...
          <div class="pointer-events-auto relative rounded-[28px] border border-base-300/80 bg-base-100/95 p-4 shadow-2xl backdrop-blur-xl">
            <div class="flex items-start gap-3">
              <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-secondary/12 text-secondary">
            ...
            <div class="mt-4 flex gap-2">
              ...
              <button
                ...
                class="btn btn-secondary btn-sm flex-1 rounded-2xl"
              >
                {t("nearby.accept")}
              </button>
            </div>
