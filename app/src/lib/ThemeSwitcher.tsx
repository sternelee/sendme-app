...
const themes: ThemeOption[] = [
  ...
  { id: "synthwave", name: "Synthwave", icon: Monitor, preview: "bg-purple-900" },
  { id: "cyberpunk", name: "Cyberpunk", icon: Monitor, preview: "bg-yellow-500" },
...
export function ThemeSwitcher(props: ThemeSwitcherProps) {
  ...
  return (
    <div class={`relative theme-switcher ${props.class || ""}`}>
      ...
      <Show when={isOpen()}>
        <div class="absolute right-0 mt-2 w-56 bg-base-100 rounded-xl border border-base-300 shadow-xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <div class="space-y-1">
              <For each={themes}>
                {(theme) => (
                  ...
                  >
                    <div class={`w-5 h-5 rounded-full ${theme.preview} flex items-center justify-center`}>
